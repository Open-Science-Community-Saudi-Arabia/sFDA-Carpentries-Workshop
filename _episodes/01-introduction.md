...
we are specifically using [RStudio Cloud](https://rstudio.cloud/),
a version of RStudio that can be accessed in your web browser. RStudio Cloud
has the same features of the Desktop version of RStudio you could download as
standalone software.

## Log on to RStudio Cloud

Sign up on [RStudio Cloud](https://rstudio.cloud/plans/free) using either Google or GitHub.
...
<img src="../fig/signup_page.png" alt="rstudio default session" style="width: 1000px;"/>

After signing up with GitHub, you should now see the RStudio Cloud:

<img src="../fig/rstudioCloud.png" alt="rstudio default session" style="width: 1000px;"/>
...
<img src="../fig/new-project.png" alt="rstudio default session" style="width: 600px;"/>
